...
OUTPUT_SCHEMA: str = """{
    ...
    "ai_opinion": "AI의 의견(종합 요약 1~2문장)",
    "detailed_description": "정의(1줄)|특징(증상)(2줄)|원인(1줄)을 포함한 설명",
    "precautions": ["주의점1(1줄)", "주의점2(1줄)", "주의점3(1줄)"],
    "management": {
        "일상 관리법(가정에서의 피부 관리, 샤워법 등)(1줄)": "",
        "의학적 치료법(1줄)(연고, 경구약, 물리치료 등)": "",
        "생활습관(1줄)(재발 방지법, 환경 개선법)": "",
        "기타(1줄)": ""
    },
    "출처": {
        "기관명": "",
